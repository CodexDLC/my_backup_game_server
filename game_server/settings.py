...
# Celery
RABBITMQ_URL = os.getenv("RABBITMQ_URL", "amqp://guest:guest@localhost:5672//") # Возьмет из .env
CELERY_BROKER_URL = os.getenv("CELERY_BROKER_URL", RABBITMQ_URL) # Возьмет из .env (или RABBITMQ_URL)
CELERY_RESULT_BACKEND = os.getenv("CELERY_RESULT_BACKEND", REDIS_URL) # Возьмет из .env (или REDIS_URL)