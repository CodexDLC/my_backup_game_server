...
# Импорт моделей
from game_server.common_contracts.api_models.system_api import GetAllStateEntitiesRequest, GetStateEntityByKeyRequest
from game_server.common_contracts.shared_models.api_contracts import APIResponse, BaseRequest, SuccessResponse
