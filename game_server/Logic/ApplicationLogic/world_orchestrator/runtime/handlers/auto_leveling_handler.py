# game_server/Logic/ApplicationLogic/world_orchestrator/runtime/handlers/auto_leveling_handler.py
...
from game_server.Logic.ApplicationLogic.world_orchestrator.start_orcestrator_utils.batch_utils import split_into_batches
